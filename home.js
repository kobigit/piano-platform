...
CanvasRenderer.prototype.resize = function (width, height, keyvalues) {


    Renderer.prototype.resize.call(this, width, height, keyvalues);
    ...
    ctx.drawImage(imgKeyObj, ctx.lineWidth / 2, ctx.lineWidth / 2, this.whiteKeyWidth - ctx.lineWidth, this.whiteKeyHeight - (this.whiteKeyHeight * 0.1));
    var musicNote = document.getElementById("music_note");
    ctx.drawImage(musicNote, ctx.lineWidth / 2, this.whiteKeyHeight * 0.7, this.whiteKeyWidth - ctx.lineWidth, this.whiteKeyHeight * 0.1)
    var imageshadow = document.getElementById("img_whiteshadow");
    ctx.drawImage(imageshadow, 0, this.whiteKeyHeight - (this.whiteKeyHeight * 0.1), this.whiteKeyWidth, 30);
    ctx.fillStyle = "white";
    ctx.font = "15px Arial";
    ctx.fillText("A1", 4, this.whiteKeyHeight - (this.whiteKeyHeight * 0.04));
    ...
    ctx.fillText("A#/B", ctx.lineWidth ,this.blackKeyHeight*0.85,this.blackKeyWidth,30);
    ...
    for (var i in this.piano.keys) {
        ...
        if (key.sharp) {
            key.rect = new Rect(this.blackKeyOffset + this.whiteKeyWidth * key.spatial, 0,
                this.blackKeyWidth, this.blackKeyHeight - 5);
        } else {
            key.rect = new Rect(this.whiteKeyWidth * key.spatial, 0,
                this.whiteKeyWidth, this.whiteKeyHeight - 10);
        }
    }
};
...
$("#play-alone-btn").on("click", function (evt) {
    $("#play-alone-btn").css('background-color', '#f77058')
    evt.stopPropagation();
